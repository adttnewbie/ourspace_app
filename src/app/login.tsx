  ...
  return (
    <View className="flex-1 bg-[#FDFCF8] overflow-hidden">
      <View pointerEvents="none" className="absolute inset-0 overflow-hidden">
        ...
        <View className="absolute top-[300px] -left-16 w-[200px] h-[200px] rounded-full bg-[#B4EBFF] opacity-[0.08]" />
      ...
      >
        <View className="w-full max-w-[400px] self-center flex-1">
          ...
          <View
            ...
            style={{ borderColor: hasError ? C.error : C.ink, shadowColor: C.ink, shadowOpacity: 0.14, elevation: 3, shadowRadius: 0, shadowOffset: { width: 4, height: 4 } }}
          >
